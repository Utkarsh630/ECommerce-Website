...
<body style="padding-top: 50px;">
            ...
            <div class="col-sm-9 text-center">
                   ...
                   <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="col-sm-4 home-feature">
                            <div class="thumbnail">
                                <a href = "project_description.php?id=4"><img src="./img/iphonex.png" alt="iphone x" ></a>
                                    <div class="caption">
                                        <h3>iPhone X</h3>
                        ...
                        <div class="col-sm-4 home-feature">
                            <div class="thumbnail">
                               <a href = "project_description.php?id=6"> <img src="./img/samsungs8.png" alt="samsung s8 plus"></a>
                                    <div class="caption">
                    ...
                    <div class="col-sm-4 home-feature">
                        <div class="thumbnail">
                        <a href="project_description.php?id=12"> <img src="./img/op5t.png" alt="oneplus 5t"></a>
                                <div class="caption">
                                    <h3>OnePlus 5T</h3>
                                        <p>Price: Rs. 36000.00 </p>
                                                <?php if (!isset($_SESSION['email'])) { ?>
                    ...
                    <div class="col-sm-4 home-feature">
                        <div class="thumbnail">
                        <a href="project_description.php?id=16">    <img src="./img/mimix2.png" alt="mi mix 2"></a>
                                <div class="caption">
                                    <h3>Mi Mix 2</h3>
                                        <p>Price: Rs. 36000.00 </p>
                                                <?php if (!isset($_SESSION['email'])) { ?>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-sm-4 home-feature">
                            <div class="thumbnail">
                               <a href="project_description.php?id=3"><img src="./img/ipnone7plus.png" alt="ipnone 7 plus"></a>
                                    <div class="caption">
                                        <h3>iPhone 7 PLUS</h3>
                    ...
                    <div class="col-sm-4 home-feature">
                        <div class="thumbnail">
                            <a href="project_description.php?id=2"><img src="./img/iphone7.png" alt="iphone 7"></a>
                                <div class="caption">
                                    <h3>iPhone 7</h3>
                    ...
                    <div class="col-sm-4 home-feature">
                        <div class="thumbnail">
                           <a href="project_description.php?id=1"></a> <img src="./img/iphone6splus.png" alt="iphone 6s plus"></a>
                                <div class="caption">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="col-sm-4 home-feature">
                            <div class="thumbnail">
                            <a href="project_description.php?id=6">    <img src="./img/samsungs8.png" alt="galaxy s8 plus" ></a>
                                    <div class="caption">
                        ...
                        <div class="col-sm-4 home-feature">
                            <div class="thumbnail">
                                <img src="./img/samsungnote8plus.png" alt="note 8 plus">
                                    <div class="caption">
                                        <a href="project_description.php?id=7"><h3>Samsung Galaxy Note 8 PLUS</h3></a>
                                            <p>Price: Rs. 60000.00 </p>
                                                <?php if (!isset($_SESSION['email'])) { ?>
                                            <p><a href= "#" data-toggle="modal" data-target="#loginmodal"  role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                                <?php
                    ...
                    <div class="col-sm-4 home-feature">
                        <div class="thumbnail">
                          <a href="project_description.php?id=5">  <img src="./img/samsungs7edge.png" alt="galaxy s7 edge"></a>
                                <div class="caption">
                    ...
                    <div class="col-sm-4 home-feature">
                        <div class="thumbnail">
                           <a href="project_description.php?id=8"> <img src="./img/samsunga8.png" alt="galaxy a8"></a>
                                <div class="caption">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-sm-4 home-feature">
                            <div class="thumbnail">
                               <a href="project_description.php?id=11"> <img src="./img/op5.png" alt="oneplus 5"></a>
                                    <div class="caption">
                                        <h3>OnePlus 5</h3>
                    ...
                    <div class="col-sm-4 home-feature">
                        <div class="thumbnail">
                           <a href="project_description.php?id=6"> <img src="./img/op3t.png" alt="oneplus 3t"></a>
                                <div class="caption">
                                    <h3>OnePlus 3T</h3>
                    ...
                    <div class="col-sm-4 home-feature">
                        <div class="thumbnail">
                            <a href="project_description.php?id=9"><img src="./img/op3.png" alt="oneplus 3"></a>
                                <div class="caption">
                                    <h3>OnePlus 3</h3>
                   ...
                   <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="col-sm-4 home-feature">
                            <div class="thumbnail">
                          <a href="project_description.php?id=16"><img src="./img/mimix2.png" alt="mi mix2" ></a>
                                    <div class="caption">
                                        <h3>Mi Mix 2</h3>
                                        <p>Price: Rs. 36000.00 </p>
                                                <?php if (!isset($_SESSION['email'])) { ?>
                        ...
                        <div class="col-sm-4 home-feature">
                            <div class="thumbnail">
                                <a href="project_description.php?id=15"><img src="./img/mimax2.png" alt="mi max 2"></a>
                                    <div class="caption">
                                        <h3>Mi Max 2</h3>
                    ...
                    <div class="col-sm-4 home-feature">
                        <div class="thumbnail">
                            <a href="project_description.php?id=14"><img src="./img/mia1.png" alt="mi a1"></a>
                                <div class="caption">
                                    <h3>Mi A1</h3>
                    ...
                    <div class="col-sm-4 home-feature">
                        <div class="thumbnail">
                         <a href="project_description.php?id=13">  <img src="./img/redminote4.png" alt="redmi note 4"></a>
                                <div class="caption">
                                    <h3>Redmi Note 4</h3>
    ...
    <a href="body.php" class="btn btn-primary" >Next</a>
